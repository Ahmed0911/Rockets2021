...
void EtherDriver::Init()
{
    ...
    g_pui8MACAddr[5] = 0x45;


	// lwIP Ethernet
	lwIPInit(g_ui32SysClock, g_pui8MACAddr, inet_addr("201.0.168.192"), inet_addr("0.255.255.255"), inet_addr("1.0.168.192"), IPADDR_USE_STATIC); 	// Set IP
